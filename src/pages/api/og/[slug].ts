...
export const GET: APIRoute = async ({ params }) => {
  ...
  const items =
    demo.vertical === 'tienda' ? await getProducts(demo.id) :
    demo.vertical === 'concesionario' ? await getVehicles(demo.id) :
    await getProperties(demo.id);
